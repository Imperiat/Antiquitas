...
[[
	...
	{
		return Color;
		// TODO - This is broken on glsl and I don't have the will to fix it right now
		// float LocalTime = (GlobalTime / 20);
		// float LerpFactor = 0.25;
		// float LerpY = 0.4;
